...
def handle_income_statement(request):
    # Logic for handling income_statement
    selector = Selector(request.html_text)
    logging.debug("handle_income_statement")
    try:
...
PAGE_TYPE_HANDLERS = {
    "income_statement": handle_income_statement,
    "balance_sheet": handle_balance_sheet,
    "cash_flow": handle_cash_flow
}
